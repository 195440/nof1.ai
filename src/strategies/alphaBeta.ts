...
5. **反转单必须确认，不能只看 RSI 极值**
   ...
   - 做多/做空都只要求看到 5m 首轮结构变化，再配合 15m 至少一个同向确认
   - 不必死等 15m EMA20/EMA50、MACD、RSI 全部一起翻向，避免把反转单等成追涨杀跌
...
- **首轮确认即可试仓**：5m 出现首轮结构变化，且 15m 至少有一个同向确认，即可执行，不必等所有慢指标完全翻向
...
- 只要 5m 已经出现首轮结构变化，且 15m 至少出现一个同向确认，就可以执行
- 如果缺少这些确认，结论只能是继续观望
